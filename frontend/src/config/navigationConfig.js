...
import {
  ...
  Megaphone,
  Activity,
  Plug, DatabaseBackup } from "lucide-react";
...
export const PAGE_META = {
  ...
  documents: { title: "Dokumen · Invoice & Kwitansi", kicker: "CRM & Keuangan" },
  ...
  data: { title: "Manajemen Data · Backup & Restore", kicker: "Sistem" },
...
export const NAV_TREE = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "documents", label: "Dokumen", icon: FileText, path: "/app/documents" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "data", label: "Manajemen Data", icon: DatabaseBackup, path: "/app/data" },
...
export const ROLE_MENU_ALLOWLIST = {
  owner: ["dashboard", "bookings", "calendar", "dispatch", "driver-workspace", "gps", "maintenance", "partners", "vehicles", "drivers", "customers", "masterdata", "crm", "quotations", "inbox", "automation", "finance", "documents", "reports", "ads", "landing", "tracking", "integrations", "cms", "media", "users", "settings", "data", "auditlog"],
  ops_admin: ["dashboard", "bookings", "calendar", "dispatch", "driver-workspace", "gps", "maintenance", "partners", "vehicles", "drivers", "customers", "masterdata", "crm", "quotations", "inbox", "automation", "finance", "documents", "data", "reports", "ads", "cms", "media"],
