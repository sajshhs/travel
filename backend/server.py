...
app.include_router(documents.router)    # Dokumen bisnis: kwitansi, konfirmasi, SPJ, konfigurasi kop/naskah/penomoran
app.include_router(data_management.router)  # Manajemen Data: backup/restore lengkap + cron harian
...
app.add_middleware(
    ...
    expose_headers=["X-Total-Count", "X-Limit", "X-Offset", "X-Row-Count"],
)
